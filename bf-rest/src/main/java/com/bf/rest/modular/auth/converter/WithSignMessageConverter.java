package com.bf.rest.modular.auth.converter;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import com.bf.rest.modular.auth.security.DataSecurityAction;
import com.bf.core.exception.BfException;
import com.bf.core.support.HttpKit;
import com.bf.core.util.MD5Util;
import com.bf.rest.common.exception.BizExceptionEnum;
import com.bf.rest.config.properties.JwtProperties;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new BfException(BizExceptionEnum.SIGN_ERROR);
        }
