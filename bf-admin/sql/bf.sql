...
/*DROP DATABASE IF EXISTS bf_flowable;
CREATE DATABASE IF NOT EXISTS bf_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;*/

DROP DATABASE IF EXISTS bf;
CREATE DATABASE IF NOT EXISTS bf DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
INSERT INTO `sys_menu` VALUES ('168', 'expense', '0', '[0],', '报销管理', 'fa-clone', '#', '2', '1', '1', null, '1', null);
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1', '世界', '10', '欢迎使用Basic Frame管理系统', '2017-01-11 08:53:20', '1');
INSERT INTO `sys_notice` VALUES ('2', '你好', null, '你好', '2017-05-10 19:28:57', '1');
