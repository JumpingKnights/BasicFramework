...
import com.bf.config.properties.BfFlowableProperties;
import com.bf.core.datasource.DruidProperties;
import com.bf.core.flowable.GunsDefaultProcessDiagramGenerator;
...
public class FlowableConfig extends AbstractProcessEngineAutoConfiguration {
    ...
    @Autowired
    BfFlowableProperties bfFlowableProperties;
    ...
    private DruidDataSource flowableDataSource() {
        ...
        //flowable单独的数据源
        //bfFlowableProperties.config(dataSource);
        return dataSource;
    }
